...
export default function ClientCard({ client, onDeleteClick, onEditClick, onAddClick }: { client: Client; onDeleteClick?: (client: Client) => void; onEditClick?: (client: Client) => void; onAddClick?: (client: Client) => void }) {
    return (
